...
public class GamemodeCommands implements Cmd {
	...
	public String permissions(@NotNull String command) {
		return switch (command) {
			case "gmc" -> "poscbox.command.gamemode.creative";
			case "gms" -> "poscbox.command.gamemode.survival";
			case "gma" -> "poscbox.command.gamemode.adventure";
			case "gmsp" -> "poscbox.command.gamemode.spectator";
			default -> null;
		};
	}
}
