package me.lord.poscbox.scoreboard;
...
import me.lord.poscbox.utilities.PlayerUtil;
...
public class FastBoard {
	...
	public void updateAll() {
		updateTitle(TextUtil.cs("&6&lPosc &7(" + TextUtil.format(PoscBox.onlinePlayers) + "/" + TextUtil.format(Bukkit.getMaxPlayers()) + ")"));
		updateLines(
				"",
				...
				"&6KDR&7: &f" + TextUtil.format(PlayerUtil.getKDR(getPlayer())),
				"&6Killstreak&7: &f" + TextUtil.format(DataManager.getPlayerData(getPlayer()).getKillstreak()),
				"",
	...
	public void updateConstant() {
		updateLine(7, "&6Ping&7: &f" + TextUtil.format(getPlayer().getPing()) + " ms");
		updateLine(8, "&6TPS&7: &f" + TextUtil.format(Bukkit.getTPS()[0]));
	}

	public void updateBalance() {
		updateLine(1, "&6Balance&7: &f" + TextUtil.formatMoney(PlayerData.getBalance(getPlayer())));
	}
	...
	public void updateKDR() {
		updateLine(4, "&6KDR&7: &f" + TextUtil.format(PlayerUtil.getKDR(getPlayer())));
	}
